<template>
    <div>
        <button style="margin: 30px 25% 10px; width: 50%; height: 24px; color: var(--vscode-button-foreground); background-color: var(--vscode-button-background);" @click="getExtensionPath">extension path</button>
